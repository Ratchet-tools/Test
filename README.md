...
<tr>
   ...
   <tr>
   <td width="5%"> install: </td>  <td width="5%"> Bool </td> <td width="35%"> install: true</td> 
   <td width="50%">The values.yam file contains several sections and they are representing particular application or it's part. 
